...
function renderTable(tableLines) {
  ...
  if (coverIndex !== -1) {
    rows.forEach((row) => {
      if (!row[coverIndex]) {
        row[coverIndex] = "![No cover available](/karl/assets/images/no-cover.svg)";
      }
    });
  }
  ...
  return entries
    .map(
      ({ slug, title, hasTitle, created }) =>
        `<li><a href="/karl/${section.name}/${slug}">${escapeHtml(
...
<html lang="en">
  <head>
    ...
    <link rel="apple-touch-icon" sizes="180x180" href="/karl/assets/apple-touch-icon.png" />
    <link rel="icon" type="image/png" sizes="32x32" href="/karl/assets/favicon-32x32.png" />
    <link rel="icon" type="image/png" sizes="16x16" href="/karl/assets/favicon-16x16.png" />
    <link rel="manifest" href="/karl/assets/site.webmanifest" />
    <link rel="stylesheet" href="/karl/assets/css/main.css" />
    <script src="/karl/assets/js/theme-toggle.js"></script>
    <script src="/karl/assets/js/copy-code.js"></script>
    <script src="/karl/assets/js/table-view.js"></script>
  </head>
  <body>
    <!-- include:header -->
    <main class="content">
...
<html lang="en">
  ...
  <body>
    <!-- include:header -->
    <main class="content">
      <link rel="stylesheet" href="/karl/assets/css/log.css" />
      <article class="log-entry">
        <div class="log-content">
          <a href="/karl/${section.name}" class="log-back">&larr; ${
            section.backLabel
          }</a>
          ${content}
        </div>
...
const SHELVES_LINKS = [
  { href: "/karl/shelves/books", label: "Books" },
  { href: "/karl/shelves/music", label: "Music" },
  { href: "/karl/shelves/games", label: "Games" },
];
