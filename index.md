...
Building cross-platform mobile apps for iOS and Android with React Native.
{: .print-only}
...
Built a mobile app and an interactive website for clients, using React Native, GSAP, and Pixi.
{: .print-only}
...
Built a C# app for comparing bus connections.
{: .print-only}
...
Mobile development (job and hobby), gaming, hiking, and my dog, [Marli]({{ "/dog" | absolute_url }}). For more of my writing, see [the blog]({{ "/blog" | absolute_url }}); for everything that didn't make the cut here, see [the other side of this site]({{ "/karl" | absolute_url }}).
